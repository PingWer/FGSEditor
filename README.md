...
**FGSEditor** is a graphical tool designed to view, edit, and create Film Grain Synthesis (FGS) tables. It allows you to modify FGS tables generated by [`grav1synth`](https://github.com/rust-av/grav1synth), create new ones from scratch (WIP), or generate them using presets (WIP).
